...
const CLEAN_INGREDIENT_INFO = "CLEAN_INGREDIENT_INFO";
...
const FEED_CONNECT = "FEED_CONNECT";
const FEED_DISCONNECT = "FEED_DISCONNECT";
const FEED_WS_CONNECTING = "FEED_WS_CONNECTING";
const FEED_WS_OPEN = "FEED_WS_OPEN";
const FEED_WS_CLOSE = "FEED_WS_CLOSE";
const FEED_WS_ERROR = "FEED_WS_ERROR";
const FEED_WS_MESSAGE = "FEED_WS_MESSAGE";

const ORDERS_CONNECT = "ORDERS_CONNECT";
const ORDERS_DISCONNECT = "ORDERS_DISCONNECT";
const ORDERS_WS_CONNECTING = "ORDERS_WS_CONNECTING";
const ORDERS_WS_OPEN = "ORDERS_WS_OPEN";
const ORDERS_WS_CLOSE = "ORDERS_WS_CLOSE";
const ORDERS_WS_ERROR = "ORDERS_WS_ERROR";
const ORDERS_WS_MESSAGE = "ORDERS_WS_MESSAGE";

const PLACE_ORDER_VIEW_REQUEST = "PLACE_ORDER_VIEW_REQUEST";
const SET_ORDER_VIEW = "SET_ORDER_VIEW";
const PLACE_ORDER_VIEW_FAILED = "PLACE_ORDER_VIEW_FAILED";
const CLEAN_ORDER_VIEW = "CLEAN_ORDER_VIEW";
